...
|---|---|
| [Project Management Overview](octoacme-project-management-overview.md) | High-level overview of OctoAcme's project management principles, roles, lifecycle, and key artifacts |
...
| [Project Planning](octoacme-project-planning.md) | Detailed guidance on scope, resources, milestones, and dependency planning |
| [Execution and Tracking](octoacme-execution-and-tracking.md) | How to run sprints, track progress, manage blockers, and maintain delivery momentum |
...
These documents are designed to help every member of the OctoAcme team — regardless of experience level — understand and apply consistent project management practices. Use them to:

- **Standardize** how projects are initiated, planned, executed, and closed across all teams.
- **Share** institutional knowledge so that process expertise is not locked in any single person's head.
- **Accelerate onboarding** so that new team members can quickly ramp up on workflows, roles, and expectations without needing to shadow others for weeks.

If you are using this repository as a source in a Copilot Space, these docs provide the structured context Copilot needs to answer process questions, generate templates, and guide the team through each project phase.
